...
<head>
  ...
  <div id="intro" class="bg-image vh-120 shadow-1-strong">
    <video style="min-width: 100%; min-height: 100%;" playsinline autoplay muted loop>
      <source class="h-100" src="https://MERN Stack Teamwow.cov-19awareness.com/cat_4.mp4" type="video/mp4" />
    </video>
  ...
  <div class="card-body">';
    ...
    echo '<div class="row">
        ...
        <div class="d-flex flex-row align-items-center mb-4">
            ...
            <div class="col">
              <input style="height:40px;" class="form-control" type="text" placeholder="First Name" name="firstname" value="';
    if (isset($_POST['firstname'])) echo $_POST['firstname'];
    echo '" >
            </div>
            &nbsp;&nbsp;
            <div class="col">
            <input style="height:40px;" class="form-control" type="text" placeholder="Last Name" name="lastname" value="';
    ...
    echo '" >
      ...
      <div class="d-flex flex-row align-items-center mb-4">
            ...
            <div class="col">
            <input style="height:40px;" class="form-control" type="email" placeholder="Email" name="email" value="';
    ...
    echo '" >
      ...
      <div class="d-flex flex-row align-items-center mb-4">
            ...
            <div class="col-md-3">
              <input style="height:40px;" class="form-control" type="text" placeholder="Area Code" name="areacode" value="';
    if (isset($_POST['areacode'])) echo $_POST['areacode'];
    echo '">
            </div>
              &nbsp;
            <div class="col">
              <input style="height:40px;" class="form-control" type="text" placeholder="Phone Number" name="phoneno" value="';
