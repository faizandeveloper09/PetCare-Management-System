...
<body>
  ...
  function showeditForm($petid)
  {
    ...
    if ($num == 1) {
      ...
      echo '
                        ...
                        <i class="fas fa-exclamation-circle"></i>&nbsp;&nbsp;You are going to make changes for your pet <b><i>';
      echo $row['pet_name'];
      echo '.</i></b> Click on Save Changes button to continue.';
  ...
  function successMessage()
  {
    ...
    echo "'mypet.php?editpet=success';";
    echo '",2000);
                      </script>';
  } //END FUNCTION
