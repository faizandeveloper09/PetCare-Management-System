...
<body>
  ...
  function showForm($petid)
  {
    ...
    <div class="alert alert-danger border-danger" role="alert">';
      echo '<div><i class="fa fa-question-circle"></i>&nbsp;&nbsp;Are you sure to delete your pet name <b>';
      echo $row['pet_name'];
      echo '</b> ?</div></div>';
      echo '<div class="row g-2">
            <div class="col-md">
              <div class="form-floating">
              <input type="text" class="form-control rounded-5" value="';
      echo $row['pet_id'];
      echo '" disabled>
      ...
      echo '<div class="row g-2 mb-3">
        <div class="col-md">
        <div class="form-floating">
        <textarea disabled class="form-control" style="height: 80px">';
      echo $row['pet_partnership_pro'];
      echo '</textarea>
      ...
      echo '" method="post">
        <div class="row g-2 mb-2">
          <div class="col-md">
            ...
            <label class="form-check-label" for="yesDelete">Yes, I want to delete my pet <b><i>';
      echo $row['pet_name'];
      echo '</i></b> from the system.</label>
            </div>
          </div>
        </div>';
...
myModal.show();
  ...
  setTimeout("location.href =';
    echo "'mypet.php?deletepet=success';";
    echo '",2000);
  </script>';
  } //
