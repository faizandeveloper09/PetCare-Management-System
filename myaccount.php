  ...
  function showForm($memberid)
  {
    ...
    if ($num == 1) {
      ...
      echo '" name="username" disabled>
                         ...
                         <div class="col-md">
                            <div class="form-floating">
                              <input type="email" class="form-control rounded-5" value="';
      echo $row['email'];
      echo '" name="email">
      ...
      echo '<div class="row g-2">
                     <div class="col-md">
                        <div class="form-floating">
                          <input type="date" class="form-control rounded-5" value="';
      echo $row['birth_date'];
      echo '" id="dob" name="birthdate">
