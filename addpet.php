...
<body>
  ...
  function addForm()
  {
    echo '
          ...
          <input type="text" class="form-control rounded-5" id="floatpetname" placeholder="Pet Name" name="petname" value="';
    if (isset($_POST['petname'])) echo $_POST['petname'];
    echo '">
